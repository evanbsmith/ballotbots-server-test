...
import './electionTurnoutChart.html';
import './electionTurnoutChart.scss';


// define template stuff here

Template.electionTurnoutChart.onCreated(function(){
  console.log('Template electionTurnoutChart created');
...
Template.electionTurnoutChart.onRendered(function(){
  ...
  this.autorun(() => {
    if(this.subscriptionsReady()){
      console.log('electionTurnoutChart Subscriptions ready!');
...
Template.electionTurnoutChart.helpers({
  electionId: function(){
...
Template.electionTurnoutChart.events({
