...
import './electionAccelerationChart.html';
import './electionAccelerationChart.scss';


// define template stuff here

Template.electionAccelerationChart.onCreated(function(){
  console.log('Template electionAccelerationChart created');
...
Template.electionAccelerationChart.onRendered(function(){
  console.log('Template electionTurnoutChart rendered');

  let canvasEl = this.find('canvas');

  this.autorun(() => {
    if(this.subscriptionsReady()){
      console.log('electionAccelerationChart Subscriptions ready!');
...
Template.electionAccelerationChart.helpers({
  electionId: function(){
...
Template.electionAccelerationChart.events({
