...
import './orgElections.html';
import './orgElections.scss';
...
Template.orgElections.onCreated(function(){
  console.log('Template orgElections created');
...
Template.orgElections.onRendered(function(){
  console.log('Template orgElections rendered');
  console.log('Template orgElections currentData()', this.data);
